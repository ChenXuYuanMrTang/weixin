...
//
//public class touminghua extends View{
//
...
//        private int mLastY;
//
//        public touminghua(Context context) {
//            super(context);
//            init();
//        }
//
//        public touminghua(Context context, AttributeSet attrs) {
//            super(context, attrs);
//            init();
//        }
//
//        public touminghua(Context context, AttributeSet attrs, int defStyleAttr) {
